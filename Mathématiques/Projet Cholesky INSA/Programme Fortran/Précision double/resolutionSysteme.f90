...
contains
	...
	subroutine descente(L, b, n)
		...
		double precision, intent(in) :: L(n,n) ! matrice carrée triangulaire inférieure
		double precision, intent(inout) :: b(n) ! vecteur b sera modifié en vecteur resultant à la résolution
	...
	subroutine remontee(U, b, n)
		...
		double precision, intent(in) :: U(n,n) ! matrice carrée triangulaire supérieure
		double precision, intent(inout) :: b(n) ! vecteur b sera modifié en vecteur resultant à la résolution
		integer :: i,j ! variables locales pour boucler 
	...
	subroutine resolution(L, b, n)
		...
		integer, intent(in) :: n ! dimension de la matrice carrée triangulaire inférieure L et du vecteur b
		double precision, intent(in) :: L(n,n) ! matrice carrée triangulaire inférieure obtenue avec cholesky
		double precision, intent(inout) :: b(n) ! vecteur b sera modifié en vecteur resultant à la résolution
