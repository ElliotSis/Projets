...
router.put('/:id', function(req, res) {
    ...
    Joueur.findById(id, function(err, joueur) {
        if (err) {
            ...
            joueur.endurancePlus = req.body.endurance ? req.body.endurance : joueur.endurancePlus;
            joueur.enduranceBase = req.body.enduranceb ? req.body.enduranceb : joueur.enduranceBase;
        ...
        if (err) {
            ...
            avancement.save(function(err) {
                if (err) {
                    ...
                    req.session.currentPageId = avancement.pageId;
