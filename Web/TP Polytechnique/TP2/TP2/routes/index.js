...
images['Short Sword'] = 'Short Sword.png';
images['Spear'] = 'Spear.png';
images['Mace'] = 'Mace.png';
images['Axe'] = 'Axe.png';
images['Warhammer'] = 'Warhammer.png';
images['Quarterstaff'] = 'Quarterstaff.png';
images['Broadsword'] = 'Broadsword.png';
images['Padded Leather Waistcoat'] = 'Padded Leather Waistcoat.png';
images['Potion of Laumspur'] = 'Potion of Laumspur.png';
images['Special Rations'] = 'Special Rations.png';
...
router.get('/combat:valeur', function(req, res, next) {
  ...
  res.render('combat', { title: 'Combat' , combat_skill:combat_skill, endurance:endurance, gold:gold, name:name,
    player_disciplines:player_disciplines, player_weapons:player_weapons, player_backpack:player_backpack, player_special_items:player_special_items, descriptions:descriptions,
...
router.get('/jeu/:valeur', function(req, res, next) {
  ...
  res.render('p' + page, { title: 'Page ' + page, combat_skill:combat_skill, endurance:endurance, gold:gold, name:name,
    player_disciplines:player_disciplines, player_weapons:player_weapons, player_backpack:player_backpack,             player_special_items:player_special_items, descriptions:descriptions,
    combats:combats });
});
