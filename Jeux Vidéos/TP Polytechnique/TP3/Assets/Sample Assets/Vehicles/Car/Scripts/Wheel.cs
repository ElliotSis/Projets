...
public class Wheel : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
		...
		if (wheelModel != null)
		{
			...
			//MODIFICATION ADIREN POUR LES NOUVELLES ROUES
			wheelModel.localRotation = Quaternion.AngleAxis(wheelCollider.steerAngle, Vector3.up) * Quaternion.Euler(0, 90, spinAngle);
		}
	}
}
