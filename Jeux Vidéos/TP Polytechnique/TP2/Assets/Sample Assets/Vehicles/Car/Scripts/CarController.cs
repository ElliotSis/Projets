...
public class CarController : MonoBehaviour
{
	...
	public void Move (float steerInput, float accelBrakeInput, bool nitro, bool jump)
    {
		...
		// Rotation in the air
		if (!anyOnGround) {
			RotateInTheAir(steerInput, accelBrakeInput);
		}
	...
	void RotateInTheAir(float horizontal, float vertical) {
		transform.Rotate(vertical*verticalAirFactor, horizontal*horizontalAirFactor, 0f);
	}
